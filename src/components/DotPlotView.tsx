...
export function DotPlotView() {
  const { clusterStats } = useDataStore();
  ...
  const geneOrder = [
    "THY1", "ITGBL1", "RUNX2", "PTN", "SOX9", "DLX5", "TNN", "TNC",
    "PTH1R", "ALPL", "MYLK", "MYL9", "ACTA2", "ENG", "PECAM1", "CD74",
    "CSF1R", "CD14", "FCER1A", "KIT", "CD3E", "CTSW"
  ];
  ...
  return (
    <div className="h-full bg-[#0d1117] p-3">
      <div className="h-full bg-[#161b22] rounded-xl border border-[#30363d] overflow-hidden flex flex-col shadow-lg">
        <div className="px-4 py-2.5 border-b border-[#21262d] text-xs font-semibold text-[#e6edf3] shrink-0">
